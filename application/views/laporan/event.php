		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
                    <form action="<?= base_url('laporan/hasil_event/'); ?>" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="form-group row">
                                            <div class="form-group col-4">
                                                ...
                                                <select class="form-control" name="id_jenis_event" id="id_jenis_event">
                                                    <option value="0">Semua</option>
                                                    <?php foreach ($jenis as $key => $value) {?>
                                                        <option value="<?= $value['id_jenis_event']?>"><?= $value['nama_jenis_event']?></option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                            <div class="form-group col-4">
