...
<div class="container p-0">
        <div class="card px-4">
            ...
            <span class="text-center">ID : <?= $detail_pembayaran['id_event']?></span>
            <hr>
            <div class="row gx-3">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="d-flex flex-column">
                        <p class="text mb-1">Jenis Event</p>
                        <input class="form-control mb-3" type="text" value="<?= $detail_pembayaran['nama_jenis_event']?>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="d-flex flex-column">
                ...
                <div class="col-6">
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control mb-3" type="text" value="<?= $detail_pembayaran['tgl_transaksi']?>">
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex flex-column">
                ...
                <div class="col-12">
                    <a class="btn btn-success mb-3 mt-2" href="<?= base_url('transaksi/event/')?>">Kembali</a>
                </div>
            </div>
        </div>
    </div>
